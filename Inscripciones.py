...
class Inscripciones:
    ...
    def __init__(self, master=None):
        ...
        self.lblNoInscripcion.configure(background="#575669", 
                                        foreground="white", 
                                        font="{Arial} 11 {bold}",
        ...
        self.lblIdAlumno.configure(background="#575669", foreground="white",  text='Id Alumno:')
        ...
        self.lblNombres.configure(background="#575669", foreground="white", text='Nombre(s):')
        ...
        self.lblApellidos.configure(background="#575669", foreground="white", text='Apellido(s):')
        ...
        self.lblIdCurso.configure(background="#575669", foreground="white", state="normal",text='Id Curso:')
        ...
        self.lblDscCurso.configure(background="#575669", foreground="white", state="normal",text='Curso:')
    ...
    def cargar_tV(self,orden="Código_Curso",inscrito=False):
        ...
        if inscrito:
            ...
            if self.id_Curso.get() != "" and self.descripc_Curso.get() != "":
                busqueda = f" AND Cursos.Código_Curso LIKE '%{self.id_Curso.get()}%' AND Descripción LIKE  '%{self.descripc_Curso.get()}%' "
            elif self.id_Curso.get() != "":
                busqueda = f" AND Cursos.Código_Curso LIKE '%{self.id_Curso.get()}%' "
            elif self.descripc_Curso.get() != "":
                busqueda = f" AND Descripción LIKE '%{self.descripc_Curso.get()}%' "
            ...
            query =f""" SELECT Cursos.*, Inscritos.Jornada FROM Cursos INNER JOIN Inscritos 
                    ...
                    WHERE No_Inscripción = '{self.num_Inscripcion.get()}' {busqueda} ORDER BY {orden}"""
            ...
            query =f"""SELECT Cursos.* FROM Cursos LEFT JOIN Inscritos 
                    ...
                    WHERE Inscritos.Código_Curso IS NULL {busqueda} ORDER BY {orden}"""
    ...
    def eleccion_jornada(self,id_Curso,curso):
        ...
        lblInfo.configure(background="#30393E",foreground="white",state="normal",
        ...
        lblCurso.configure(background="#30393E",foreground="white",state="normal",text=f"ID: {id_Curso}  | Curso: {curso}")
        lblCurso.place(anchor="center", x=150, y=45)
        
        lblJornada = ttk.Label(frm, name="lbljornada")
        lblJornada.configure(background="#30393E",foreground="white",state="normal",
    ...
    def ventana_edicion(self,id_Curso_Seleccionado,curso_Seleccionado,no_Inscripcion_Seleccionado,jornada_Seleccionada):
       ...
       # Establecer el icono de la ventana segun el sistema operativo
        ...
        lblCambioJornada.configure(background="#252330",foreground="white",state="normal",text='Cambio de jornada del curso seleccionado:')
        lblCambioJornada.place(anchor="w", x=20, y=20)
        
        
        lblIdCurso = ttk.Label(frm, name="lblidcurso")
        lblIdCurso.configure(background="#252330",foreground="white",state="normal",text='Id Curso:')
        ...
        lblDscCurso.configure(background="#252330",foreground="white",state="normal",text='Curso:')
        ...
        lblJornada = ttk.Label(frm, name="lbljornada")
        lblJornada.configure(background="#252330",foreground="white",state="normal",text='Jornada:')
        ...
        lblIdCursoNew.configure(background="#06141B",foreground="orange",state="normal",text='Id Curso:')
        ...
        lblDscCursoNew.configure(background="#06141B",foreground="orange",state="normal",text='Curso:')
        ...
        lblJornadaNew.configure(background="#06141B",foreground="orange",state="normal",text='Jornada:')
